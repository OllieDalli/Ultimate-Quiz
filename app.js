...
function handleRoundIntroPhase() {
    ...
    roundIntroTimer = setTimeout(async () => {
        ...
        const nextPhase = (nextType === "song" || nextType === "speed") ? "question" : "selecting";
...
async function beginRound() {
    ...
    game = { ...game, current_round_type: roundType, phase: "round-intro", current_question_id: null, current_answer: null, question_started_at: null };
    updateGameState();
}
...
async function startNextRound() {
    ...
    game = { ...game, round: nextRound, current_round_type: nextRoundType, phase: "round-intro", current_question_id: null, current_answer: null, question_started_at: null };
    updateGameState();
}
