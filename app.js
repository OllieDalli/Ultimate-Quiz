...
function renderQuestion() {
    ...
    const answersToRender = currentRoundType === "song"
...
async function submitAnswer(answer) {
    ...
    // Song selections are deliberately local. This indicator is rendered
    // only in this browser and is never written to shared game state.
...
function createRandomRoundTypeOrder(totalRounds = 10) {
    ...
    // Fully random pattern. Consecutive Classic or Song rounds are allowed.
    // We keep an even 5/5 split across the 10-round game.
